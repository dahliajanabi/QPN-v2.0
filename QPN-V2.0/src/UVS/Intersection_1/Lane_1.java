...
public class Lane_1 {
	...
	public static void main(String[] args) {
		...
		p_csi2.SetValue(new Qplace(new Vvector(1, new QBit(new ComplexValue(Ro, 0.0f), new ComplexValue(0.0f, Ro))),
				QplacePrintSetting.Both));
		...
		p_r1_o.Value = new TransferOperation("localhost", "3084", "p_i1");
		pn.PlaceList.add(p_r1_o); 
		
		DataTransfer p_f2_o = new DataTransfer();
		p_f2_o.SetName("p_f2_o");
		p_f2_o.Value = new TransferOperation("localhost", "2081", "p_i2");
