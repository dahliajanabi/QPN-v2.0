...
public class Lane_4 {
	...
	public static void main(String[] args) {
		...
		p_o.SetName("p_o");
		p_o.Value = new TransferOperation("localhost", "1080", "p_i4");
		...
		//Lane split output channels
				...
				p_f2_o.Value = new TransferOperation("localhost", "3084", "p_i2");
		...
		System.out.println("Quantum Lane_4_Intersection_1 started \n ------------------------------");
		pn.Delay = 1000;
		pn.clearPrint = true;
