...
public class Intersection_3 {

	public static void main(String[] args) {

		PetriNet pn = new PetriNet();
		pn.PetriNetName = "Intersection_3";
		pn.NetworkPort = 3080;
		...
		p_o1_out.Value = new TransferOperation("localhost", "4081", "p_i1"); // to Intersection 4 lane 1
		pn.PlaceList.add(p_o1_out);

		DataTransfer p_o2_out = new DataTransfer();
		p_o2_out.SetName("p_o2_out");
		p_o2_out.Value = new TransferOperation("localhost", "1082", "p_i1"); // to Intersection 1 lane 2
		...
		grdT4out.Activations.add(new Activation(t4out, "P_s3",TransitionOperation.SendOverNetwork, "p_o1_out"));  
