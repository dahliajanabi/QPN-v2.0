...
public class Lane_3 {
	...
	public static void main(String[] args) {
		...
		p_o.SetName("p_o");
		p_o.Value = new TransferOperation("localhost", "3080", "p_i3");
		...
		//Lane split output channels
				...
				p_r1_o.Value = new TransferOperation("localhost", "1082", "p_i1");
		...
		System.out.println("Quantum Lane_3_Intersection_3 started \n ------------------------------");
		pn.Delay = 1000;
		pn.clearPrint = true;
