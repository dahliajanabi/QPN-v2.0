...
public class Lane_2 {
	...
	public static void main(String[] args) {
		...
		p_o.SetName("p_o");
		p_o.Value = new TransferOperation("localhost", "3080", "p_i2");
		...
		//Lane split output channels
				...
				p_r1_o.Value = new TransferOperation("localhost", "4081", "p_i1");
				pn.PlaceList.add(p_r1_o); 
				
				DataTransfer p_f2_o = new DataTransfer();
				p_f2_o.SetName("p_f2_o");
				p_f2_o.Value = new TransferOperation("localhost", "1082", "p_i2");
		...
		System.out.println("Quantum Lane_2_Intersection_3 started \n ------------------------------");
		pn.Delay = 1000;
		pn.clearPrint = true;
