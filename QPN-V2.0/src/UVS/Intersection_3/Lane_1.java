...
public class Lane_1 {
	...
	public static void main(String[] args) {
		...
		p_o.SetName("p_o");
		p_o.Value = new TransferOperation("localhost", "3080", "p_i1");
		...
		//Lane split output channels
				...
				p_f2_o.Value = new TransferOperation("localhost", "4081", "p_i2");
		...
		System.out.println("Quantum Lane_1_Intersection_3 started \n ------------------------------");
		pn.Delay = 1000;
		pn.clearPrint = true;
