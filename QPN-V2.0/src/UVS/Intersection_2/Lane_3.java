...
public class Lane_3 {
	...
	public static void main(String[] args) {
		...
		p_o.SetName("p_o");
		p_o.Value = new TransferOperation("localhost", "2080", "p_i3");
		...
		//Lane split output channels
				...
				p_f2_o.Value = new TransferOperation("localhost", "1083", "p_i2");
		...
		System.out.println("Quantum Lane_3_Intersection_2 started \n ------------------------------");
		pn.Delay = 1000;
		pn.clearPrint = true;
