...
public class PetriNet implements PetriObject, Runnable, Cloneable, Serializable {
	...
	public void PrintThis(String text, Exception e) {   //for fast execution no printing comment this method only
	...
	public DataQplace getPlaceByName(String pName) throws CloneNotSupportedException {
