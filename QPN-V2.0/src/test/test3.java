...
//ttt
		...
		p1.SetName("p1");
		p1.Value = new ComplexVector(8, new ComplexValue(1.0f, 0.0f), new ComplexValue(0.0f, 0.0f),
		...
		p2.SetName("p2");
		p2.Value = new ComplexVector(8, new ComplexValue(1.0f, 0.0f), new ComplexValue(0.0f, 0.0f),
				new ComplexValue(0.0f, 0.0f), new ComplexValue(0.0f, 0.0f), new ComplexValue(0.0f, 0.0f),
				new ComplexValue(0.0f, 0.0f), new ComplexValue(0.0f, 0.0f), new ComplexValue(0.0f, 0.0f));
		pn.PlaceList.add(p2);
		...
		//grdT1.Activations.add(new Activation(t1, "p1", "A1", TransitionOperation.Hadamart, "p3"));
		//grdT1.Activations.add(new Activation(t1, "p2", "A1", TransitionOperation.Hadamart, "p4"));
		...
		//grdT2.Activations.add(new Activation(t2, "p3", TransitionOperation., "p1"));
		...
		//grdT3.Activations.add(new Activation(t3, "p4", TransitionOperation.move, "p2"));
