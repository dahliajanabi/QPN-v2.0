...
public class QFLPNModel {
	public static void main(String[] args) {
		...
		QFLRS QFLRS1 = new QFLRS(new FV(FZ.A1), new FV(FZ.A1), new FV(FZ.A1), new FV(FZ.A1), 
								new FV(FZ.A1), new FV(FZ.A2), new FV(FZ.A2), new FV(FZ.A3), 
								new FV(FZ.A1), new FV(FZ.A2), new FV(FZ.A3), new FV(FZ.A3),
		...
		QFLRS QFLRS3 = new QFLRS(new FV(FZ.A3), new FV(FZ.A3), new FV(FZ.A1), new FV(FZ.A1), 
								new FV(FZ.A2), new FV(FZ.A2), new FV(FZ.A2), new FV(FZ.A2), 
								new FV(FZ.A2), new FV(FZ.A3), new FV(FZ.A3), new FV(FZ.A1),
		...
		p1.SetName("p1");
		p1.Value =  new Qplace(
				new Psivector(4, new ComplexValue(0.1f, 0.0f), new ComplexValue(0.3f, 0.0f), 
						new ComplexValue(0.4f, 0.0f), new ComplexValue(0.2f, 0.0f)),QplacePrintSetting.PsiOnly);
		pn.PlaceList.add(p1);

		DataQplace p2 = new DataQplace(); // Pb
		p2.SetName("p2");
		p2.Value =  new Qplace(
				new Psivector(4, new ComplexValue(0.5f, 0.0f), new ComplexValue(0.3f, 0.0f), 
						new ComplexValue(0.2f, 0.0f), new ComplexValue(0.0f, 0.0f)),QplacePrintSetting.PsiOnly);
		pn.PlaceList.add(p2);

		DataQplace p3 = new DataQplace(); // p1 Psi3
		p3.SetName("p3");
		p3.Value =  new Qplace(
				new Psivector(4, new ComplexValue(0.2f, 0.0f), new ComplexValue(0.2f, 0.0f), 
						new ComplexValue(0.0f, 0.0f), new ComplexValue(0.6f, 0.0f)),QplacePrintSetting.PsiOnly);
		pn.PlaceList.add(p3);
